...
public final class GrupoEntity {
	...
	public GrupoEntity(final UUID id, final ProfesorEntity profesor, final MateriaEntity materia, final int cantidadEstudiantes, final boolean activo ) {
		setId(id);
	...
	private void setActivo(Boolean activo) {
		this.activo = ObjectHelper.getDefault(activo,BooleanHelper.FALSE);
	}
	...
	private void setDefaultActivo() {
		Boolean defaultValue = BooleanHelper.FALSE;
		setActivo(defaultValue);
	}
