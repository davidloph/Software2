...
public class ValidatorAsisteUcoException extends AsisteUcoException {
    ...
    public static  ValidatorAsisteUcoException create(final String userMessage, final String technicalMessage,
                                                           final Exception rootException) {
        return new ValidatorAsisteUcoException(userMessage, technicalMessage, rootException, Layer.VALIDATOR);
    }

    public static  ValidatorAsisteUcoException create(final String userMessage) {
