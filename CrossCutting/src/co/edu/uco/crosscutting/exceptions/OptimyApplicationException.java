...
public class OptimyApplicationException extends RuntimeException {
	...
	public OptimyApplicationException(final String userMessage, final String technicalMessage,
